@extends('app')
@section('title')
    Safe Travel {{ config('app.seperator') }}{{ config('app.name') }}
@endsection
@section('article', 'Safe Travel')
@section('styles')
    <link rel="stylesheet" href="{{ asset('/css/extensions/faq.css') }}">
